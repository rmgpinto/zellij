...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Payload {
        ...
        SetTerminalTitlePayload(super::SetTerminalTitlePayload),
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetTerminalTitlePayload {
...
impl CommandName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            CommandName::SetTerminalTitle => "SetTerminalTitle",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SetTerminalTitle" => Some(Self::SetTerminalTitle),
            _ => None,
        }
    }
}
